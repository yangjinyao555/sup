   //创建和初始化地图函数：
    ...
    function createMap(){
        ...
        var point = new BMap.Point(116.498638,39.94639);//定义一个中心点坐标
    ...
    //标注点数组
    var markerArr = [{title:"我的标记",content:"我的备注",point:"116.495836|39.945948",isOpen:0,icon:{w:21,h:21,l:0,t:0,x:6,lb:5}}
		 ];
    //创建marker
    function addMarker(){
